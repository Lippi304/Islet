...
| 002 | spotify-queue-scripting | standard | Given Spotify is playing, when queried via AppleScript or the local Spotify Web API, then the next 5 queued tracks are retrievable | PENDING | spotify, applescript, phase-74 |
