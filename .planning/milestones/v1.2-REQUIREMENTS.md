# Requirements Archive: v1.2 Now Playing Polish
...
- [x] **NOW-04**: User does not see the Now Playing glance at Islet launch if the detected player only has a paused/loaded track — the glance appears only once the user actually presses Play
