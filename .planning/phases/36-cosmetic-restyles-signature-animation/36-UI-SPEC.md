...
**Approval:** PASS — checker feedback incorporated in commit `ac748e2` (spacing exception for the 14px right-wing padding, HUD focal-point note, locked Skiper UI attribution line resolved).
