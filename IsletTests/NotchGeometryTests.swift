...
final class NotchGeometryTests: XCTestCase {
    ...
    // (round 2: width 840 -> 750; round 3: width 750 -> 650; round 8: trayContentHeight
    // reverted 150 -> 128 after fixing shelfRow's ScrollView centering bug — rounds 4-5's
    // growth was compensating for that bug, not a real space shortage) per on-device UAT.
